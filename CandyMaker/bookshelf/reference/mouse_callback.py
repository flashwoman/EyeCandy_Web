...
def mouse_callback(event, x, y, flags, param):
    ...
    if event == cv.EVENT_LBUTTONDOWN:
        ...
        if hsv[0] < 10: # hue가 따뜻한 빨강에 가까울때
            ...
            print("case3")
            lower_color1 = np.array([hsv[0] - 10, threshold, threshold])
            upper_color1 = np.array([hsv[0] + 10, hsv[1]+5, hsv[2]+20])
            lower_color2 = np.array([hsv[0] - 10, threshold, threshold])
            upper_color2 = np.array([hsv[0], hsv[1], hsv[2]+20])
            lower_color3 = np.array([hsv[0] - 10, threshold, threshold])
            upper_color3 = np.array([hsv[0], hsv[1] + 5, 255])
...
while (True):
    ...
    # path = "C:/flashwoman/Object-detection/image/bookshelf_04.jpg"
    ...
    # 책장추출 마스크 저장하기
    path = "C:/flashwoman/Object-detection/image/img_bookshelf_mask.jpg"
    ...
    path = "C:/flashwoman/Object-detection/image/img_book_only.jpg"
    ...
    path = "C:/flashwoman/Object-detection/image/img_color_morphed.jpg"
